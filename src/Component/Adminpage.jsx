...
const Adminpage = () => {
    ...
    const ActiveShowroom = (id) =>{
        setShowrooms(showrooms.map((showroom) =>
            showroom.id === id ? { ...showroom, status:"Active"} : showroom
        ))
        alert("Showroom has been Active.");
    };
            ...
            <div className="flex min-h-screen bg-gray-100">
                ...
                <main className="flex-1 p-8">
                    <Routes>
                        ...
                        <Route path="/showrooms" element={<Showroom showrooms={showrooms} banShowroom={banShowroom} ActiveShowroom={ActiveShowroom} />} />
                    </Routes>
                </main>
            </div>
        </Router>
